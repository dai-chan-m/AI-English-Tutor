    ...
    <main className="min-h-screen bg-gradient-to-b from-blue-100 to-white flex flex-col items-center justify-center px-4 py-20">
      ...
      <div className="text-center max-w-xl mb-12">
        ...
        <p className="text-gray-600 text-lg">
          AIが英語学習をサポート。効率的に英語力を伸ばしたい学習者におすすめ！
          <br />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
        ...
        >
          ...
          <p className="text-gray-500 text-sm mb-3">英検・TOEIC対策に最適な単語練習</p>
          <ul className="list-inside list-none space-y-2 text-sm text-gray-700 text-left">
            <li>✅ <span className="font-medium">英検・TOEIC</span>レベルに合わせた単語テスト</li>
            <li>✅ CEFR（A1〜C2）レベル別の<span className="font-medium">英語学習</span>教材</li>
            <li>✅ 印刷可能な<span className="font-medium">英単語ドリル</span>をAIが自動生成</li>
          </ul>
        </div>
        ...
        >
          ...
          <ul className="list-inside list-none space-y-2 text-sm text-gray-700 text-left">
            <li>✅ <span className="font-medium">英作文添削</span>をAIが日本語で丁寧に解説</li>
            <li>✅ <span className="font-medium">英語ライティング</span>の弱点を分析</li>
        ...
        >
          ...
          <p className="text-gray-500 text-sm mb-3">毎日続ける英語学習習慣づくり</p>
          <ul className="list-inside list-none space-y-2 text-sm text-gray-700 text-left">
            <li>✅ 毎日更新の<span className="font-medium">英単語問題</span>で学習継続</li>
            <li>✅ <span className="font-medium">英検・TOEIC</span>頻出単語を効率的に学習</li> 
